  ...
  <div class="relative">
    <div
      ...
      <div class="rickandmorty-section lg:w-1/2 space-y-4 p-10 min-h-[600px]">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Chaos, comedy, and the multiverse collide!</h1>
      ...
      <div class="lg:w-1/2 space-y-4 p-10 bg-green-700 rounded-3xl min-h-[600px]">
        <div v-if="rickAndMortyStore.characterDetail">
          ...
          <h1 class="text-4xl font-bold text-white">{{ rickAndMortyStore.characterDetail.name }}</h1>
